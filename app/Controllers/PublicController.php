...
class PublicController
{
    ...
    public function lookup(): void
    {
        ...
        // Якщо введене схоже на ТТН — прямо про це й кажемо (найчастіша помилка).
        if (Validate::looksLikeNpTtn($orderNumber)) {
            Response::json([
                'ok'      => true,
                'found'   => false,
                'ttn_hint'=> true,
                'message' => 'Схоже, ви вказали номер накладної Нової пошти (ТТН), а не номер замовлення. '
                           . 'Номер замовлення коротший — знайдіть його в SMS або листі про підтвердження '
                           . 'замовлення та введіть сюди.',
            ]);
        }
    ...
    public function submit(): void
    {
        ...
        // Типова плутанина: клієнт вставив ТТН Нової пошти замість номера
        // замовлення. Якщо замовлення так і не знайшлось, а введене схоже
        // на ТТН — не створюємо «сиру» заявку, а просимо виправити.
        if ($sdOrder === null && $orderNumber !== null && Validate::looksLikeNpTtn($orderNumber)) {
            $errors['order_number'] = 'Схоже, ви вказали номер накладної Нової пошти (ТТН), '
                . 'а не номер замовлення. Номер замовлення коротший — знайдіть його в SMS '
                . 'або листі про підтвердження замовлення.';
        }

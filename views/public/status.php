...
<?php else: ?>
    ...
    <?php if ($status === 'need_more_info'): ?>
        <div class="alert alert--warn">
            За заявкою потрібні додаткові дані або фото товару чи упаковки.
            Менеджер зв’яжеться з вами для уточнення — або ви можете самі зателефонувати менеджеру,
            з яким спілкувалися. <strong>Не відправляйте товар, доки заявку не погоджено.</strong>
        </div>
    <?php endif; ?>
        ...
        <div class="card">
            ...
            <?php if (!$isOurNp): ?>
                <div class="alert alert--warn" style="margin-top:0">
                    <strong>Заявку ще не завершено.</strong> Відправте товар одним зі способів нижче.
                    Якщо це <u>не</u> «Легке повернення», обовʼязково впишіть номер ТТН у форму —
                    інакше ми не знатимемо, що очікувати вашу посилку, і повернення не рухатиметься далі.
                </div>
            <?php endif; ?>
            ...
            <?php else: ?>
                ...
                <div class="option">
                    ...
                    <div class="hint" style="margin-bottom:10px">
                        При оформленні накладної: отримувача вкажіть точно як вище, тип доставки —
                        «у відділення», а в описі вмісту напишіть <strong>«Повернення товару»</strong> і номер
                        вашої заявки <span class="mono"><?= e($rma['rma_number']) ?></span>.
                    </div>

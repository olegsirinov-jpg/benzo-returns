...
<div class="card center" style="max-width:620px;margin:0 auto">
    ...
    <p class="small muted" style="text-align:left">
        Щойно повернення погодять, на <strong>сторінці статусу</strong> зʼявиться покрокова інструкція,
        як відправити товар (зокрема безкоштовне «Легке повернення» Нової пошти). Відстежити заявку
        можна за цим номером і вашим телефоном у будь-який момент.
    </p>
